...
Writing Streaming Queries Against {{ site.ak-tm }} Using KSQL (Local) {#ksql_quickstart-local}
=====================================================================
...
Create a Stream and Table {#ksql-create-a-stream-and-table}
=========================
...
Using Nested Schemas (STRUCT) in KSQL {#struct-support-local}
-------------------------------------
...
Stream-Stream join {#ss-joins-local}
------------------
...
Table-Table join {#tt-joins-local}
----------------
...
Terminate and Exit {#terminate-local}
==================
